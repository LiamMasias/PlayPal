...
// async function getGameInfo(gameId) {
//   let data = `fields cover.url, id,name,aggregated_rating,genres.name, screenshots.url, storyline ;\nsort aggregated_rating desc;\nwhere id = ${gameId};`;
//   const config = {
//     method: "post",
//     maxBodyLength: Infinity,
//     url: "https://api.igdb.com/v4/games",
...
//   try {
//     const response = await axios.request(config);
//     return response.data[0]; // Assuming that you only expect one result based on the provided gameId
//   } catch (error) {
//     console.log(error);
//     throw new Error("Failed to fetch game information from IGDB");
//   }
